...
<dnn:DnnCssInclude ID="DnnCssInclude1" runat="server" FilePath="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.0/css/bootstrap.min.css" Priority="20" />
<dnn:DnnCssInclude ID="DnnCssInclude2" runat="server" FilePath="css/carousel.css" PathNameAlias="SkinPath" Priority="25" />
...
<dnn:DnnJsInclude ID="DnnJsInclude1" runat="server" FilePath="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.0/js/bootstrap.min.js" />
...
<div id="myCarousel" runat="server" class="carousel slide" data-ride="carousel"></div>
