...
<xmod:Template runat="server" ID="LocationTemplate" UsePaging="True" Ajax="True" AddRoles="Administrators" EditRoles="Administrators" DeleteRoles="Administrators">
  ...
  <CustomCommands>
    <DataCommand CommandName="DeleteLocation" CommandText="DELETE FROM XMP_Classified_Location WHERE [LocationID] = @LocationID">
                  ...
                  <xmod:Select runat="server" Mode="Standard">
                  	<Case Comparetype="Role" Operator="=" Expression="Administrators">
                        ...
                        <xmod:CommandLink runat="server" Text="Delete" OnClientClick="return confirm('Are you sure?');">
                          <Command Name="DeleteLocation" Type="Custom">
