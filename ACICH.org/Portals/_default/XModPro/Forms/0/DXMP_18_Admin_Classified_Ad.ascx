...
<xmod:FormView runat="server"><AddItemTemplate><xmod:AddForm runat="server" Clientname="Ad">
  ...
  <ScriptBlock ScriptId="CustomCSS" BlockType="HeadScript" RegisterOnce="true">
    <style type="text/css">
      ...
      li.children { display: none; }
      li.children.show { display: block; }
      ...
      .post-ad-form .admin-functions h3, .post-ad-form .user-options h3 {
        margin-top: 0px;
        padding-bottom: 10px;
      }
  ...
  <div class="form-horizontal post-ad-form">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
				<DropDownList Id="LocationID" CssClass="form-control required-field" Nullable="true" DataField="LocationID" DataSourceId="cds_Locations" DataTextField="CityState" DataValueField="LocationID" AppendDataBoundItems="true" DataType="int32">
    ...
    <div class="form-group">
      <label for="Ad_Price" CssClass="col-sm-2 control-label">Price</label>
      <div class="col-sm-10">
        <div class="input-group">
          <div class="input-group-addon">$</div>
					<TextBox Id="Ad_Price" cssClass="form-control" Width="150" Nullable="True" DataField="Ad_Price" DataType="decimal" />
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
				<TextArea Id="Ad_Summary" CssClass="form-control" Nullable="true" DataField="Ad_Summary" DataType="string" MaxLength="250" CharacterCount="CountDown" CharacterCountLabel=" remaining" />
      </div>      
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <rmg:Xile runat="server" 
          ...
          ResizeVersions="width=800;height=600;mode=max, md_:width=400;height=400;mode=max, sm_:width=200;height=200;mode=max, thm_:width=100;height=100;mode=max"
          UniqueFileName="True"
          UploadMode="Single"
    ...
    <div class="well well-small col-sm-offset-2 col-sm-10 user-options">
      <h3>Categories <small><em>Select at least one category.</em></small></h3>
    	<ListBox Id="Categories" CssClass="form-control" Nullable="true" DataField="Categories" DataType="String" DataSourceId="cds_Categories" DataTextField="Category_Name" DataValueField="CategoryID" AppendDataBoundItems="true" Rows="4" SelectionMode="Multiple" />
      <ul id="Categories_Container"></ul>
      <Validate Target="Categories" CssClass="validate-error" Type="required" Message="Please select at least one category." Text="*" /> 
    </div>      
    
    <div class="well well-small col-sm-offset-2 col-sm-10 user-options">
      <h3>Visibility Options <small><em>Control what is publicly seen on this Ad.</em></small></h3>
      <div class="checkbox">
        <CheckBox Id="ShowAddress" DataField="ShowAddress" DataType="boolean" /> <strong>Show Address</strong>
      </div>
      <div class="checkbox">
        <CheckBox Id="ShowPhone" DataField="ShowPhone" DataType="boolean" /> <strong>Show Phone</strong>
      </div>
      <div class="checkbox">
        <CheckBox Id="ShowEmail" DataField="ShowEmail" DataType="boolean" /> <strong>Show Email</strong>
      </div>
    </div>
    ...
    <div class="alert alert-warning col-sm-offset-2 col-sm-10 admin-functions">
      ...
      <div class="checkbox">
				<CheckBox Id="Approved" DataField="Approved" DataType="boolean" /> <strong>Approved</strong>
      </div>
      <div class="checkbox">
        <CheckBox Id="Active" DataField="Active" DataType="boolean" /> <strong>Active</strong>
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
				<AddButton CssClass="btn btn-primary" Text="Post Ad" Redirect="/Admin/Classifieds-Admin/Sellers" RedirectMethod="get" />
      	<CancelButton CssClass="btn btn-default" Text="Cancel" Redirect="/Admin/Classifieds-Admin/Sellers" RedirectMethod="get" />
      </div>      
    </div>
  </div>  
  ...
  <script>
    $(document).ready(function() {
      var $select = $('#' + Ad.Categories).hide(),
          $container = $('#Categories_Container'),
          checkboxes = '';

      $select.children('option').each(function() {
        var $option, val, text, textTrim, checkbox, isParent;
        $option = $(this);
        val = $option.val();
...
<EditItemTemplate><xmod:EditForm runat="server" Clientname="Ad">
  ...
  <SelectCommand CommandText="SELECT 
                              ...
                              ,(SELECT Seller_Name FROM XMP_Classified_Seller WHERE SellerID = a.SellerID) AS Seller_Name
                              
                              
                              FROM XMP_Classified_Ad a WHERE [AdID]=@AdID">
